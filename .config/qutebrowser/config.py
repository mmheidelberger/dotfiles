...
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}',
                       ...
                       'ar': 'https://wiki.archlinux.org/index.php?title=Special%3ASearch&search={}',
                       'e': 'https://www.ebay.com/sch/{}',
                       'a': ('http://www.amazon.com/s?url=search-alias%3Daps&field-keywords={}').replace(" ", "+")
                      }
...
#custom defined/normal mode
config.bind(',m', 'spawn youtube-dl --extract-audio --audio-format mp3 {url}')
